	...
	for hit in hits:
		...
		if hit.HITStatus == "Reviewable":
			...
			for assignment in assignments:
				...
				conn.approve_rejected_assignment(assignment.AssignmentId, feedback="Our apologies. We reverted our decision to approve your work. Thanks again for your participation.");
